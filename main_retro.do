******************************************************************************
* SINGLE-YEAR FORMAT FILE FOR WORKING HISTORIES
******************************************************************************
...
* 1. Formatting
******************************************************************************
* Reads personal, pension and afiliation files. Saves afilianon${year}.dta
...
* Variabke for age 
capture gen age_in = year(dtin)-year(dtbirth)
...
* Option selected at begining of file
...
* 3 Appendix: Other auxiliary variables (optional)
******************************************************************************
...
* Save the file
save "./MCVL_${year}_retro.dta", replace