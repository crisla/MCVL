...
by id: replace state2="U" if state[_n]!="U"&state[_n+1]!="U"&state!="R"&state[_n+1]!="R"&diff_days>15&regular_dismissal==1&diff_days<365*2
...
sort id year jobcount cdtin cdtout hidden_u
...
* use for tables and alike - 17.38%
...
// ------------+-----------------------------------
//           0 |    809,928       37.00       37.00
//           1 |    569,897       26.03       63.03
//           2 |    809,403       36.97      100.00
// ------------+-----------------------------------
//       Total |  2,189,228      100.00
...
* Drop in between unemployment spells as a result of the cleaning (721 observations, almost zero)
by id: replace days_c = cdtout-cdtin+1 if old_obs==0
drop if days_c<0
