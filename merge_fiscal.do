...
replace av_income = av_income/cop
replace av_income_m = av_income*30

* Uncomment to export a csv file with the resulting wages (for figures and tables)
// export delimited id state jobcount av_income av_income_m days cop start_inc sevpay age if av_income!=.&av_income!=0&_merge!=2&dtout>td(01jan2005)&av_income!=av_income[_n-1]&age>20&age<55 using "/home/clafuente/New/wages.csv", replace

* Future and past income - annuals
