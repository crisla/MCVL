...
* 4. Other Work Related Variables *********************************************
...
* Unfinished spell (does NOT end in employment) as of ${end_year}:
sort id jobcount dtin
gen unfin = 1 if dtout>=td(31dec${end_year})|state[_n+1]=="R"|state=="R"|cause==58|cause==56
...
* Save the file
sort id jobcount dtin dtout
saveold "./MCVL_${end_year}_retro.dta", v(12) replace
