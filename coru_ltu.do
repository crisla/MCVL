...
by id: replace mod_u  = 1           if state[_n]=="U"&unfinish==1&regular_dismissal==1&first_spell!=1
by id: replace cdtout=td(31dec2013) if state[_n]=="U"&unfinish==1&regular_dismissal==1&first_spell!=1
