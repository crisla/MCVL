***********************************************************
* Patchwork LTU expansion - expansion robustness check
***********************************************************
...
saveold "./MCVL0313_ltu.dta", replace version(12)
* Robustness checks
******************************************************************************
* 2 years
quietly do "./coru_ltu_rob2y.do"
drop if dtout<td(01jan2003)
quietly do  "../panel/quarterly_panel_U0.do"
do "./panel/robustness/export_flows_ltu_y2.do"

* 3 years
use "./MCVL0313_ltu.dta", clear
quietly do "./coru_ltu_rob3y.do"
drop if dtout<td(01jan2003)
quietly do  "../panel/quarterly_panel_U0.do"
do "./panel/robustness/export_flows_ltu_y3.do"

* 4 years
use "./MCVL0313_ltu.dta", clear
quietly do "./coru_ltu_rob4y.do"
drop if dtout<td(01jan2003)
quietly do  "../panel/quarterly_panel_U0.do"
do "./panel/robustness/export_flows_ltu_y4.do"

* 5 years
use "./MCVL0313_ltu.dta", clear
quietly do "./coru_ltu_rob5y.do"
drop if dtout<td(01jan2003)
quietly do  "./panel/quarterly_panel_U0.do"
do "./panel/robustness/export_flows_ltu_y5.do"
