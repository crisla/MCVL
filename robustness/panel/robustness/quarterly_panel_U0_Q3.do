...
gen dtoutQ1 = date("01mar"+year_s,"DMY")
gen dtoutQ2 = date("01jun"+year_s,"DMY")
gen dtoutQ3 = date("01sep"+year_s,"DMY")
gen dtoutQ4 = date("01dec"+year_s,"DMY")

gen dtinQ1 = date("15mar"+year_s,"DMY")
gen dtinQ2 = date("15jun"+year_s,"DMY")
gen dtinQ3 = date("15sep"+year_s,"DMY")
gen dtinQ4 = date("15dec"+year_s,"DMY")
