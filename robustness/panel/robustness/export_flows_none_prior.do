...
* Stocks * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * 
log using stocks_ss_none_prior.log,replace
tab time state
log close
...
log using stocks_ss_age_none_prior.log,replace
...
* Stocks by sex
log using stocks_ss_sex_none_prior.log,replace
tab time state if sex==1
tab time state if sex==2
log close

* Flows (by state) * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * 
log using flows_ss_u_none_prior.log,replace
tab time flow if state=="U"&length(flow)==2
log close

log using flows_ss_t_none_prior.log,replace
tab time flow if state=="T"&length(flow)==2
log close

log using flows_ss_p_none_prior.log,replace
tab time flow if state=="P"&length(flow)==2
log close

log using flows_ss_0_none_prior.log,replace
